...
bool MathInterpreter::declare_variable(const std::string& assigment)
{
...
std::optional<double> MathInterpreter::get_variable(const std::string& variable_name) const
{
...
double MathInterpreter::calculate(const std::string& expression) const
{
    if (expression.empty())  
    {
        return 0;
...
std::vector<std::string> MathInterpreter::get_variable_names() const
{
